...
3. Add a "Current Task" entry in CLAUDE.md's "## New Task" section pointing at the new file.
4. At Brainstorm, no GitHub issue is required (a lightweight one labeled status:brainstorm is
   ...
   body = this file's Problem statement + Conclusions — and label it status:implementation.
...
<!-- Added when advancing to Testing / Ready to Submit. Test counts, ruff status, manual
